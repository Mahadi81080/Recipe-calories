    ...
    <section className="mx-10 mb-5">
      <div className="bg-[url('https://i.postimg.cc/cCkxJcg7/Rectangle-1.jpg')] bg-cover bg-center h-[500px] text-center flex justify-center items-center rounded-xl">
        <div className="space-y-5">
          <h3 className="text-5xl font-gramond font-extrabold text-white">
            Discover an exceptional cooking <br /> class tailored for you!
          </h3>
          <p className="font-poppins text-white w-2/3 mx-auto text-lg">
            Learn and Master Basic Programming, Data Structures, Algorithm, OOP,
            Database and solve 500+ coding problems to become an exceptionally
            well world-class Programmer.
          </p>
          <button className="btn bg-green-400 text-black rounded-full text-base px-8 mr-5">
          Explore Now
          </button>
